...
const t = {
  en: {
    ...
    'about.p1': 'Systems Engineering student and infrastructure specialist<br>focused on cloud engineering.',
    'about.p2': 'Design, provision, and monitor <span class="ha">infrastructure as code</span> with <span class="ha">Terraform</span><br>across a self-hosted <span class="ha">2-node Proxmox/LXC cluster</span>, with <span class="ha">Docker</span> containers and <span class="ha">Prometheus/Grafana</span> observability.',
    'about.p3': 'Also building <span class="hc">serverless apps</span> on Google Cloud / Firebase with Git-based CI/CD —<br>backed by daily production ops experience, growing into a <span class="hp">cloud engineering</span> role.',
    // Badges
  ...
  es: {
    ...
    'about.p1': 'Estudiante de Ingeniería en Sistemas y especialista en infraestructura<br>enfocado en ingeniería cloud.',
    'about.p2': 'Diseño, aprovisiono y monitoreo <span class="ha">infraestructura como código</span> con <span class="ha">Terraform</span><br>sobre un <span class="ha">clúster Proxmox/LXC de 2 nodos</span> auto-alojado, con contenedores <span class="ha">Docker</span> y observabilidad <span class="ha">Prometheus/Grafana</span>.',
    'about.p3': 'También construyo <span class="hc">apps serverless</span> en Google Cloud / Firebase con CI/CD basado en Git —<br>respaldado por experiencia diaria en operaciones de producción, creciendo hacia un rol de <span class="hp">ingeniería cloud</span>.',
    // Badges
